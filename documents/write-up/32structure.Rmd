...
entire modeled area, early explorations indicated instability when unmirroring and expanding selectivity, thus suggesting that the data may not support realistic parameterization within the spatial model. Through
...
data-weighting, which resulted in stable weights. The weighting of
...
block) and again lifted (for the second block). Due to high correlation among parameters in the most recent block, selectivity for the Washington recreational fleet was mirrored between the early (< 2006) and late (> 2020) periods. For each break-point change in selectivity, we re-estimate all three parameters.
