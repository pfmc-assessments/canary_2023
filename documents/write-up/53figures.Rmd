...
sa4ss::add_figure(
  ...
  caption = glue::glue("Map of management and the 2023 assessment area along with fleet spatial structure and survey ranges for {spp} off the U.S. West Coast"),
...
sa4ss::add_figure(
  ...
  caption = glue::glue("Total removals for {spp} off the U.S. West Coast from 1892-2022 by fleet (TWL = trawl, NTWL = non-trawl, Rec = recreational, ASHOP = at-sea hake, FOR = foreign)"),
...
sa4ss::add_figure(
  ...
  caption = glue::glue("Illustration of types of data used for each fleet within the assessment for {spp} off the U.S. West Coast"),
...
sa4ss::add_figure(
  ...
  caption = paste0("Map of \\gls{s-wcgbt} stations and density of catches of ", spp,". Faint gray dots are tows without ", spp, ". Larger redder circles indicate higher catch rates"),
...
sa4ss::add_figure(
  ...
  alt_caption = "Two logistic curves for 2015 and 2023. The 2015 curve is shifted left of 2023 and asymptotes below 1 while the 2023 curve asymptotes at 1.",
  label = "compare_maturity"
)
```
...
sa4ss::add_figure(
  ...
  alt_caption = "Two exponential curves for 2015 and 2023. The 2023 curve is lower.",
  label = "compare_fecundity"
)
```
...
sa4ss::add_figure(
  ...
  alt_caption = "Figure of mean length with uncertainty around each point showing a decrease during early years and stable until 2010 and increasing since.",
  label = "mean-len-fit2"
)
```
...
sa4ss::add_figure(
  ...
  alt_caption = "Figure with uncertainty around each point of sparse mean length data declining to 2000 and experiencing a shift downward until 2020 after which length shifts upward.",
  label = "mean-len-fit5"
)
```
