...
####Deb Wilson-Vandenberg Index for CPFV/PC Mode (1988-1998)

The Deb Wilson-Vandenberg data set originated from an onboard observer survey conducted by \gls{cdfw} in central California from 1988-1998 and is referred to as the Deb Wilson-Vandenberg onboard observer survey [@reilly_onboard_1998]. The fine-scale catch and effort data allow better filtering of the data for indices to fishing stops within suitable habitat for the target species. Length data from this dataset was applied in the assessment but we question its representativeness as a fishery-dependent index to inform coastwide dynamics. As such, we did not pursue development of an index from this dataset.  
...
### California Remotely Operated Vehicle Survey (2015 and 2020)
