...
to determine the best fit to the data. These include correcting an error in the generation of the triennial index of abundance, which was found late in the bridging process, revisions to the fleet
...
The model contains five primary likelihood components:
