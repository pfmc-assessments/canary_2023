...
*Remove survey catches*
*Remove surface read ages*
*Simplify population structure*
*Unmirror selectivity for fleets*
*Remove fleets with limited contributions (e.g. CA rec ages, CA ASHOP comps)*
*Natural mortality structure constant*
*Selectivity structure sex-dependent*
...
The exploration of models began by bridging from the 2015 benchmark assessment model to the newest version of Stock Synthesis, version 3.30.21. Using the newest Stock Synthesis version resulting in a slightly lower spawning output starting around 1995 (Figures \ref{fig:bridge-exe-bio} and \ref{fig:bridge-exe-relbio}) due to a higher value of catchability for the Washington late triennial survey. From there, bridging from the 2015 benchmark assessment model to the current base model followed five general steps: 
