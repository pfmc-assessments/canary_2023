...
*In response: I see where you are coming from. Id still like it here because this is connected with the bridging in the text part of the TOR, and it sets the stage a bit to then go on and talk about the changes in detail.* 
...
The following state-stratified survey fleet were retained from 2015 and had
...
**Hold over from last assessment. Confirm here we did previously justify or else remove or say later**
...
input sample sizes for composition data, Stock Synthesis weights each
...
parameters representing growth ($k$ and $L_\infty$ for males and females) and
variability in growth.

We include an informative prior on female natural mortality
[lognormal(-2.74, 0.31); @hamel2022development] as well as for steepnessand penalties on
...
**MOVED FROM THE 33results section where Jim had this. Seems useful to include somewhere here**  
