...
1762 The base model parameter estimates along with approximate asymptotic standard errors
1763 (SD column) are shown in Table 20 and the likelihood components are shown in Table 21.
1764 The estimated data weights by the Francis method are shown in Table 22. Estimates of the
1765 copper rockfish population size south of Point Conception over time are shown in Table 23.
1766 The full r4ss plotting output is available in the supplementary material on the Pacific Fishery
1767 Management Council website(these figures will not be available until the assessment is
1768 finalized).
