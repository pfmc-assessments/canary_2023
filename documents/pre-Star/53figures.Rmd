...
![Historical catch reconstruction for `r spp` off the U.S. West Coast from 1892-2022 by fleet \label{fig:catches}](../figures/plots/catch2%20landings%20stacked.png){width="100%," height="100%," alt="Stacked bar plot showing catches are mainly from trawl fleets, were high from 1940-2000, foreign fishing peaked in the 1970s, fishing was near zero from 2000-2015, and then increased modestly"}
...
![Weight-length relationship \label{fig:WL}](../figures/WL.png){width="100%," height="100%," alt="Exponential weight-length curves for males and females nearly overlapping, with relatively small spread of data"}
...
![Pearson residuals for lengths in the West Coast Groundfish Bottomtrawl Survey. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:len-pearson28}](../figures/plots/comp_lenfit_residsflt28mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals with limited pattern"}
...
![Pearson residuals for lengths in the early Triennial Survey. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:len-pearson29}](../figures/plots/comp_lenfit_residsflt29mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals with limited pattern"}
...
![Pearson residuals for lengths in the late Triennial Survey. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:len-pearson30}](../figures/plots/comp_lenfit_residsflt30mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals with limited pattern"}
...
![Pearson residuals for ages in the California trawl fleet. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:age-pearson1}](../figures/plots/comp_agefit_residsflt1mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals with limited pattern except from not fitting decline as steeply in early years"}
...
![Pearson residuals for ages in the California non-trawl fleet. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:age-pearson4}](../figures/plots/comp_agefit_residsflt4mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals from sparse samples"}
...
![Pearson residuals for ages in the Oregon non-trawl fleet. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:age-pearson5}](../figures/plots/comp_agefit_residsflt5mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals from sparse samples"}
...
![Pearson residuals for ages in the Washington non-trawl fleet. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:age-pearson6}](../figures/plots/comp_agefit_residsflt6mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals without trends"}
...
![Pearson residuals for ages in the Oregon recreational fleet. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:age-pearson8}](../figures/plots/comp_agefit_residsflt8mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals underfitting older ages in recent years"}
...
![Pearson residuals for ages in the Washington recreational fleet. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:age-pearson9}](../figures/plots/comp_agefit_residsflt9mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals overfitting younger ages"}
...
![Pearson residuals for ages in the Oregon at-sea-hake fleet. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:age-pearson11}](../figures/plots/comp_agefit_residsflt11mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals with little trend"}

![Mean age for the Oregon at-sea-hake fleet fleet with 95 percent confidence intervals based on current samples sizes \label{fig:mean-age-fit11}](../figures/plots/comp_agefit_data_weighting_TA1.8_11_OR_ASHOP.png){width="100%," alt="Figure with uncertainty around each point of mean age which shows no trend"}

![Pearson residuals for ages in the Washington at-sea-hake fleet. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) \label{fig:age-pearson12}](../figures/plots/comp_agefit_residsflt12mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals with little trend"}

![Mean age for the Washington at-sea-hake fleet fleet with 95 percent confidence intervals based on current samples sizes \label{fig:mean-age-fit12}](../figures/plots/comp_agefit_data_weighting_TA1.8_12_WA_ASHOP.png){width="100%," alt="Figure with uncertainty around each point of mean age which shows no trend"}
...
![Pearson residuals for conditional age-at-length in the West Coast Groundfish Bottomtrawl Survey (plot 2 of 2). Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) and are separate for each sex (red female, and blue male)](../figures/comp_condAALfit_residsflt28mkt0_page2_custom.png){width="100%," alt="Figure showing bubble plot of Pearson residuals for males and females with pattern shaped like the age-length relationship for years 2013-2022"} ![Pearson residuals for conditional age-at-length in the early Triennial survey. Closed bubbles are positive residuals (observed \> expected) and open bubbles are negative residuals (observed \< expected) and are separate for each sex (red female, and blue male)](../figures/plots/comp_condAALfit_residsflt29mkt0.png){width="100%," alt="Figure showing bubble plot of Pearson residuals for males and females with pattern shaped like the age-length relationship for years 1980-1992"}
...
![Fit of model to \gls{s-wcgbt}. Lines represent input 95% confidence interval of survey index. \label{fig:wcgbts-fit}](../figures/plots/index2_cpuefit_28_coastwide_NWFSC.png){width="100%," height="100%," alt="Figure showing model generally fitting survey data well"}

![Fit of model to early \gls{s-tri}. Lines represent input 95% confidence interval of survey index. \label{fig:earlytri-fit}](../figures/plots/index2_cpuefit_29_coastwide_Tri_early.png){width="100%," height="100%," alt="Figure showing model over and then underestimating first two out of five years of generally declining survey index"}

![Fit of model to late \gls{s-tri}. Lines represent input 95% confidence interval of survey index. \label{fig:latetri-fit}](../figures/plots/index2_cpuefit_30_coastwide_Tri_late.png){width="100%," height="100%," alt="Figure showing model very well fitting slow increase of survey index"}

![Fit of model to log of pre-recruit survey index. Log scale is shown because model fits were difficult to evaluate on absolute index scale. Thick lines represent input 95% confidence intervals. Thin lines are 95% confidence intervals including estimated added survey standard deviation. \label{fig:prerec-fit}](../figures/plots/index5_logcpuefit_31_coastwide_prerec){width="100%," height="100%," alt="Figure showing model fits annually variable index very well with added standard error included"}
...
![Comparison of spawning depletion for data sensitivities. Scenarios are described in section \@ref(data-choices). Blue band represents 95% confidence interval from the base model. \label{fig:data-bratio-compare}](../figures/sensitivities/datacompare4_Bratio_uncertainty.png){width="100%," alt="Figure showing spawning output for all data sensitivities is similar to the base model"}

![Comparison of spawning output for data weighting sensitivities. Scenarios are described in section @(data-weighting). Blue band represents 95% confidence interval from the base model. \label{fig:weight-ssb-compare}](../figures/sensitivities/weightingcompare2_spawnbio_uncertainty.png){width="100%," alt="Figure showing major differences in spawning output when increasing length or age weights relative to the base model"}

![Comparison of spawning depletion for data weighting sensitivities. Scenarios are described in section \@ref(data-weighting). Blue band represents 95% confidence interval from the base model. \label{fig:weight-bratio-compare}](../figures/sensitivities/weightingcompare4_Bratio_uncertainty.png){width="100%," alt="Figure showing spawning output for all data sensitivities is similar to the base model except for adding Canadian catches, which results in a higher overall population scale"}
...
![Comparison of spawning depletion for productivity sensitivities. Scenarios are described in section \@ref(population-productivity). Blue band represents 95% confidence interval from the base model. \label{fig:prod-bratio-compare}](../figures/sensitivities/productivitycompare4_Bratio_uncertainty.png){width="100%," alt="Figure showing present-day spawning depletion is much higher for most structural senstivities related to productivity, except for a single natural mortality which has much lower depletion"}
...
![Likelihood profile showing support from various data sources for different values of ln(R0), the natural logarithm of unfished recruitment, relative to the base model. Values associated with likelihoods that fall below the red dashed line are within the 95% chi-squared confidence interval. \label{fig:r0-profile}](../../models/5_5_0_profile_profile_SR_LN(R0)_prior_like_0/piner_panel_SR_LN(R0).png){width="100%" height="100%" alt="Four-panel figure showing influence of different likelihood components and different fleets within age, length, and survey likelihood components on profile of unfished recruitment"}
...
![Likelihood profile showing support from various data sources for different values of female natural mortality. Change in log-likelihood is relative to the base model. Values associated the likelihoods that fall below the red dashed line are within the 95% chi-squared confidence interval. \label{fig:female-m-profile}](../../models/5_5_0_profile_profile_NatM_uniform_Fem_GP_1_prior_like_1/piner_panel_NatM_uniform_Fem_GP_1.png){width="100%" height="100%" alt="Four-panel figure showing influence of different likelihood components and different fleets within age, length, and survey likelihood components on profile of female natural mortality"}

![Likelihood profile showing support from various data sources for different values of male natural mortality. Change in log-likelihood is relative to the base model. Values associated the likelihoods that fall below the red dashed line are within the 95% chi-squared confidence interval. \label{fig:male-m-profile}](../../models/5_5_0_hessian_KLO_profile_NatM_uniform_Mal_GP_1_prior_like_1/piner_panel_NatM_uniform_Mal_GP_1.png){width="100%" height="100%" alt="Four-panel figure showing influence of different likelihood components and different fleets within age, length, and survey likelihood components on profile of male natural mortality"}
