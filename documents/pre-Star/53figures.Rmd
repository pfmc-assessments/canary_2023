...
![Aggregate length composition data for the all fisheries \label{fig:agglencomp}](../figures/plots/comp_lendat__aggregated_across_time.png){width=100% height=100% alt="Aggregate plots of length compositions for males, females, and unsexed fish across all length distributions"}
