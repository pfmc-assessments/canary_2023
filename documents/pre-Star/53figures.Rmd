...
![Comparison of base model spawning output with estimates from the models with lower likelihood found during the two rounds of jitter analyses \label{fig:jitter_compare}](../figures/plots/compare1_spawnbio.png){width=100%, alt='Figure showing five retrospective runs with slightly lower estimates of initial and ending spawning output compared to the base model'}
