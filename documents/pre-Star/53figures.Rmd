...
![Map of \gls{s-wcgbt} stations and density of catches of `r spp`. Faint gray dots are tows without `r spp`. Larger redder circles indicate higher catch rates. \{fig:wcgbts-tows}](../figures/cpue_map.png){width="100%" height="100%" alt="Map of survey tows of canary rockfish showing highest catch rates in northern Oregon and especially Washington, with catches tapering off south of San Francisco Bay and virtually no catches south of Point Conception"}
