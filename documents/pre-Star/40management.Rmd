...
**Response:** Progress remains species-specific. However, progress for major commercial groundfish species (sablefish, petrale sole) is occurring outside of regular stock assessment cycles so that it can be completed in a more intentional and less ad hoc fashion. Canary rockfish has not been prioritized for these activities by NWFSC or DFO.
