...
readr::read_csv(here('documents/tables/pacfin_lengths.csv')) |>
  ...
  sa4ss::table_format(caption = "Summary of the number of length samples and trips for commercial trawl (TWL) and non-trawl (NTWL) fleets for California (CA), Oregon (OR), and Washington (WA)",
                      ...
                      align = 'l',
                      col.names = c("Year",
                            "Trips CA TWL", "Lengths CA TWL", 
                            "Trips OR TWL", "Lengths OR TWL", 
                            "Trips WA TWL", "Lengths WA TWL",
                            "Trips CA NTWL", "Lengths CA NTWL", 
                            "Trips OR NTWL", "Lengths OR TWL", 
                             "Trips WA NTWL", "Lengths WA TWL"),
                      longtable = TRUE,
                      landscape = TRUE)
```
...
readr::read_csv(here('documents/tables/pacfin_ages.csv')) |>
  ...
  sa4ss::table_format(caption = "Summary of the number of aged samples and trips for commercial trawl (TWL) and non-trawl (NTWL) fleets for California (CA), Oregon (OR), and Washington (WA)",
                      ...
                      align = 'l',
                      col.names = c("Year",
                            "Trips CA TWL", "Ages CA TWL", 
                            "Trips OR TWL", "Ages OR TWL", 
                            "Trips WA TWL", "Ages WA TWL", 
                            "Trips CA NTWL", "Ages CA NTWL", 
                            "Trips OR NTWL", "Ages OR NTWL", 
                            "Trips WA NTWL", "Ages WA NTWL"),
                      longtable = TRUE,
                      landscape = TRUE)
```
...
table_format(x = round(timeseries,2),
                 caption = "Time series of population estimates from the base model. Spawning output is in millions of eggs and age-0 recruits is in numbers of 1000s. Note that projected 2023 and 2024 estimates of total mortality have yet to be provided, so are entered here as zero.",
                 label = "timeseries",
                 longtable = TRUE,
                 col_names = col_names,
                 row.names = FALSE)
