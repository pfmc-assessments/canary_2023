...
table_format(x = round(timeseries,2),
                 caption = "Time series of population estimates from the base model. Spawning output is in millions of eggs and age-0 recruits is in numbers of 1000s. Note that projected 2023 and 2024 have yet to be provided, so are entered here as zero.",
                 label = "timeseries",
                 longtable = TRUE,
                 col_names = col_names,
                 row.names = FALSE)
